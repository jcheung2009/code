...
%%lklhdstrct = get_lklhdstrct(batchptnstrcts,labels,name)
%%collects all patterns and associated likelihoods for the syllables in
%%labels
%%calculates the total likelihood sum
