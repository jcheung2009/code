function [pitch_data tm]=jc_pitchcontourFV(fvals,N,OVERLAP,sigma,F_low,F_high,harms,filetype)
...
for found_note=1:NumberOfNotes
    ...
    [sonogram f tm]=spectrogram(shifted(found_note,:),w,OVERLAP,N,SAMPLING); %gaussian windowed spectrogram
