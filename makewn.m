...
t=.08
totaltime=0.08 % total length includin lengths of wn & silence (zeros); silence duration = totaltime - t
fs=44100 
%lowpassfrequency (Hz)
npts=fs*t
rawdataflt=rand(npts,1)*2-1
    ...
    wavwrite(rawdatafltnrm,44100,16,filename) % go to the folder that you want to save this wn wavefile
