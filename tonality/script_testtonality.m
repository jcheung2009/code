...
[sp f t]= spectrogram(dat,512,510,512,32000);
imagesc(h1,t,f,log(abs(sp)));ylim(h1,[1000 10000]);colormap('jet');
plot(h2,[1:length(dat)]/32000,dat);
plot(h3,[1:length(tonality)]/8000,tonality);
xlabel(h3,'seconds');
...
plot(h1,vol_sal(:,1),sylls_amp_sal(:,1),'ok');hold(h1,'on');
plot(h1,vol_naspm(:,1),sylls_amp_naspm(:,1),'or');
plot(h2,vol_sal(:,2),sylls_amp_sal(:,2),'ok');hold(h2,'on');
plot(h2,vol_naspm(:,2),sylls_amp_naspm(:,2),'or');
plot(h3,vol_sal(:,3),sylls_amp_sal(:,3),'ok');hold(h3,'on');
plot(h3,vol_naspm(:,3),sylls_amp_naspm(:,3),'or');
plot(h4,vol_sal(:,4),sylls_amp_sal(:,4),'ok');hold(h4,'on');
plot(h4,vol_naspm(:,4),sylls_amp_naspm(:,4),'or');
xlabel(h4,'amplitude');
ylabel(h1,'syll amp dur (ms)');
ylabel(h2,'syll amp dur (ms)');
ylabel(h3,'syll amp dur (ms)');
ylabel(h4,'syll amp dur (ms)');
[r p] = corrcoef([vol_sal(:,1);vol_naspm(:,1)],[sylls_amp_sal(:,1);sylls_amp_naspm(:,1)]);
title(h1,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
[r p] = corrcoef([vol_sal(:,2);vol_naspm(:,2)],[sylls_amp_sal(:,2);sylls_amp_naspm(:,2)]);
title(h2,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
[r p] = corrcoef([vol_sal(:,3);vol_naspm(:,3)],[sylls_amp_sal(:,3);sylls_amp_naspm(:,3)]);
title(h3,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
[r p] = corrcoef([vol_sal(:,4);vol_naspm(:,4)],[sylls_amp_sal(:,4);sylls_amp_naspm(:,4)]);
...
plot(h1,vol_sal(:,1),sylls_tonal_sal(:,1),'ok');hold(h1,'on');
plot(h1,vol_naspm(:,1),sylls_tonal_naspm(:,1),'or');
plot(h2,vol_sal(:,2),sylls_tonal_sal(:,2),'ok');hold(h2,'on');
plot(h2,vol_naspm(:,2),sylls_tonal_naspm(:,2),'or');
plot(h3,vol_sal(:,3),sylls_tonal_sal(:,3),'ok');hold(h3,'on');
plot(h3,vol_naspm(:,3),sylls_tonal_naspm(:,3),'or');
plot(h4,vol_sal(:,4),sylls_tonal_sal(:,4),'ok');hold(h4,'on');
plot(h4,vol_naspm(:,4),sylls_tonal_naspm(:,4),'or');
xlabel(h4,'amplitude');
ylabel(h1,'syll tonal dur (ms)');
ylabel(h2,'syll tonal dur (ms)');
ylabel(h3,'syll tonal dur (ms)');
ylabel(h4,'syll tonal dur (ms)');
[r p] = corrcoef([vol_sal(:,1);vol_naspm(:,1)],[sylls_tonal_sal(:,1);sylls_tonal_naspm(:,1)]);
title(h1,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
[r p] = corrcoef([vol_sal(:,2);vol_naspm(:,2)],[sylls_tonal_sal(:,2);sylls_tonal_naspm(:,2)]);
title(h2,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
[r p] = corrcoef([vol_sal(:,3);vol_naspm(:,3)],[sylls_tonal_sal(:,3);sylls_tonal_naspm(:,3)]);
title(h3,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
[r p] = corrcoef([vol_sal(:,4);vol_naspm(:,4)],[sylls_tonal_sal(:,4);sylls_tonal_naspm(:,4)]);
title(h4,{['r=',num2str(r(2))],['p=',num2str(p(2))]});
