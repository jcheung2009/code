function [varargout] = jc_plotboutpattern(boutinfo,marker,linecolor,motif,spec_or_tempo,varargin)
...
if spec_or_tempo == 1 %only spectral
    spec = 'y';
    temp = 'n';
elseif spec_or_tempo == 0 %only tempo
    temp = 'y';
    spec = 'n';
elseif spec_or_tempo == 2 %spec and tempo
    spec = 'y';
    temp = 'y';
end
