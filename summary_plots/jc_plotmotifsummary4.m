...
h1 = subtightplot(3,2,1,[0.07 0.07],0.08,0.12);
h2 = subtightplot(3,2,2,[0.07 0.07],0.08,0.12);
h3 = subtightplot(3,2,3,[0.07 0.07],0.08,0.12);
h4 = subtightplot(3,2,4,[0.07 0.07],0.08,0.12);
h5 = subtightplot(3,2,5,[0.07 0.07],0.08,0.12);
h6 = subtightplot(3,2,6,[0.07 0.07],0.08,0.12);
jitter = (-1+2*rand)/4;
xpt = xpt+jitter;
...
temp.motifdur.mean = [mean(motifdur) mean(motifdur2)];
temp.motifdur.std = [std(motifdur) std(motifdur2)];
