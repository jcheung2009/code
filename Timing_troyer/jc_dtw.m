function  [warp,range,M,Dpath,Dcum,move] = jc_dtw(template,exemplar,varargin)
...
%% set defaults
params.metric = @mnsqrdev2;
params.mlim = ceil(.25*size(template,2));%change mlim accordingly for different syllables
params.boundary = [];
