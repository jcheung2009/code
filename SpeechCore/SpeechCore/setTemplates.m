...
%This script iterates through the available training speech wave files for 
%each speaker, obtains the feature vector matrix for each file and saves 
%all the matrices obtained in a .mat file as the reference template. To 
%train system with your own words simply change the file system directory 
%and file naming convention as appropriate to match your training speech 
%files which must be type wav.
