...
%Date:          19/03/08
%Syntax:        AllScores = DTWScores(TestMatrix,N);
%This function accepts the mfcc matrix of present input speech and computes
%its DTW score against all the reference templates. The score is rturned as
%a concatenated array of scores for all training speakers used 
%(five speakers in this particular usage).
