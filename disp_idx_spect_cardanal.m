function h_idx_spect=disp_idx_spect(idx_spect, time_spect, freq_spect, spect_floor, spect_ceil, spect_range)
...
cla
hold on
h_idx_spect=image(time_spect, freq_spect, idx_spect), colormap(cm);
hold off
