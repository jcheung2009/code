...
trials = params.trial(arrayfun(@(x) strcmp(x.condition,'naspm') | strcmp(x.condition,'iem'),params.trial));
...
for i = 1:length(params.findnote)
    ...
    pitchvolsylldur_tbl = [pitchvolsylldur_tbl; table(repmat({birdnm},numtrials,1),...
        repmat({syllid},numtrials,1),repmat({condition},numtrials,1),...
    ...
    pitchvolsylldur_corr = [pitchvolsylldur_corr; table({birdnm},{syllid},{'saline'},...
        ...
        {'birdname','syllID','condition','pitchvol','pitchsylldur',...
        'volsylldur','pitchvol_shuff','pitchsylldur_shuff','volsylldur_shuff'})];
    pitchvolsylldur_corr = [pitchvolsylldur_corr; table({birdnm},{syllid},{drug},...
