function [mdur sdur gdur mcv] = jc_plotmotifsummary3(motif_sal, motif_cond, marker, linecolor)
...
set(gca,'xlim',[0 5],'xtick',[0.5,1.5,2.5,3.5,4.5],'xticklabel',...
    {'NASPM','NASPM+muscimol','muscimol','APV','saline'});
...
plot(xpt,mn1,marker,[xpt xpt],[hi lo],linecolor,'linewidth',1,'markersize',14);
set(gca,'xlim',[0 5],'xtick',[0.5,1.5,2.5,3.5],'xticklabel',...
    {'NASPM','NASPM+muscimol','muscimol','APV','saline'});
ylabel('Duration change');
