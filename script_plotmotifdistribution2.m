...
for i = 1:length(ff)
     ...
     acorrdata = [acorrdata; [x(:).macorr]'];
     motifdurdata = [motifdurdata; [x(:).mdur]'];
     sdurdata = [sdurdata; [x(:).sdur]'];
     gdurdata = [gdurdata; [x(:).gdur]'];
     
     acorrdata_sal = [acorrdata_sal; [y(:).macorr]'];
     motifdurdata_sal = [motifdurdata_sal; [y(:).mdur]'];
     sdurdata_sal = [sdurdata_sal; [y(:).sdur]'];
     gdurdata_sal = [gdurdata_sal; [y(:).gdur]'];    
