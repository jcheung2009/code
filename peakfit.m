...
%
% T. C. O'Haver (toh@umd.edu). Version 2.3 
%  
% Example 1: 
...
%
% Example 4:
% >> peakfit([0 0 0 1 2 4 6 7 6 4 2 1 0 0 0])
% Create a small data set and fit to a Gaussian model
% ans =
%            1       7.9741       6.8279       4.4068       32.023
% Example 5: 
...
% To deal with very small data sets, use the entire signal
if length(X)<24,xx=X;yy=Y;end
...
if AUTOZERO==2, % Quadratic autozero operation if AUTOZERO==2
    lxx=length(xx);
    bkgsize=lxx/5;
    if bkgsize<2,bkgsize=2;end
