function [spect freq time_song] = PlotSpectrogram(pathname,filename,FileType,channum)
...
if (strfind(FileType,'obs'))
    ...
    elseif (strfind(FileType, 'okrank'));
        [rawsong, Fs] = ReadOKrankData(pathname, filename, channum);
...
filtsong = bandpass(rawsong,Fs,0.1,250);
        rawsong=decimate(rawsong,100);
        Fs=Fs/100;
