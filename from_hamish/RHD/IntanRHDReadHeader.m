function header=IntanRHDReadHeader(path, file);
...
header.spike_trigger_struct = struct( ...
    'voltage_trigger_mode', {}, ...
    'voltage_threshold', {}, ...
    'digital_trigger_channel', {}, ...
    'digital_edge_polarity', {} );

header.new_trigger_channel = struct(header.spike_trigger_struct);
header.spike_triggers = struct(header.spike_trigger_struct);
...
header.num_amplifier_samples = 60 * num_data_blocks;
header.num_aux_input_samples = 15 * num_data_blocks;
header.num_supply_voltage_samples = 1 * num_data_blocks;
header.num_board_adc_samples = 60 * num_data_blocks;
header.num_board_dig_in_samples = 60 * num_data_blocks;
header.num_board_dig_out_samples = 60 * num_data_blocks;

header.record_time = header.num_amplifier_samples / header.sample_rate;
% 
% if (data_present)
