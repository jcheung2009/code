 function [amplifier_data,t_amplifier,sample_rate,filedata,song]=Import_Intan_RHD2000(varargin)
 
 
 
% function [data,t_amplifier,Fs,filedata,auxchan,t_auxin]=read_Intan_RHD2000_file(path, filename,chan)
...
tic;
 filename = [varargin{1},varargin{1}];
...
if length(varargin) > 2 % Output just one Channel;
    amplifier_data=amplifier_data(varargin{3});
end;
