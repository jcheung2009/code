function [amplifier_data,t_amplifier,Fs,filedata,song]=Import_Intan_RHD2000b(filename)
...
filedata.num_amplifier_samples = 60 * num_data_blocks;
filedata.num_aux_input_samples = 15 * num_data_blocks;
filedata.num_supply_voltage_samples = 1 * num_data_blocks;
filedata.num_board_adc_samples = 60 * num_data_blocks;
filedata.num_board_dig_in_samples = 60 * num_data_blocks;

filedata.record_time = num_amplifier_samples / sample_rate;
...
% end
 ...
 Fs=sample_rate; %whm----------------------
 filedata.freqparam=frequency_parameters;
