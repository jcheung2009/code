function [] = SpikeDetectFilt(DirectoryName, FileName, FileType, ChannelNo, LowerThreshold, UpperThreshold, WindowSize, SkipWindowSize, f_low, f_high)
...
if (strfind(FileType,'okrank'))
    [RawData Fs] = ReadOKrankDataFilt([DirectoryName],[FileName],ChannelNo,f_low, f_high);
    RawData = RawData * 500/32768;
end;
