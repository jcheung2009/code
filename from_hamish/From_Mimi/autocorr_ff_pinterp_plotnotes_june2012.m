function outFF=autocorr_ff_pinterp_plotnotes(batch_in,note, ff_low, ff_hi,feature) % feature added by Raghav as an argument
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%            
specgram(syllable,500,44100,480,450),set(gca,'ylim',[0 8000]),colormap(flipud(gray)), caxis([40 100])
