...
%
%recdata.adfreq  : sampling freq in Hz
%recdata.nchan   : number of data channels
%recdata.nsamp   : numer of samples in each channel
%recdata.iscatch : ==1 means this was a catch song (no feedback given)
%recdata.ttimes  : trigger times in msecs from start of file
%recdata.tbefore : Buffer time from EvTAF(secs)
%recdata.tafter  : Silence Time from EvTAF (secs)
%recdata.thresh  : TAF trigger detectection thresholds
%recdata.outfile : wav file that was played back
%recdata.header  : rec file header
%
