function save_krank_stimuli_laser(stimset, direc, basename, varargin)
...
for kstim = 1:length(stimset.stims)
    ...
    wf = apply_krank_filters_laser(stimset.stims(kstim).signal, input_fs, 'db', 85, 'zero_pad_length', zero_pad_length, 'fs_out', fs_out);
