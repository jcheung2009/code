function [rawsong, Fs]= read_krank_file(pathname, soundfile, filetype)
...
% input.
%
% NOTE(GK): Omit FILETYPE to read little-endian(pc,linux) binary files
%
...
% GK added this to read little-endian binary files
if ~exist('filetype','var')
  sound_fid = fopen(soundfile_full,'r');
  if sound_fid == -1
