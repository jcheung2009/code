...
for ksyl = 1:length(syl_idxs)
    ...
    stimset.stims(stimcount).signal = data.syllables(syl_idxs(ksyl)).wf;
...
save_krank_stimuli(stimset, pathdata.stim_path, 'sylsongdiscrimination_syllables_201401', 'zero_pad_length',0.5,'add_null',true)