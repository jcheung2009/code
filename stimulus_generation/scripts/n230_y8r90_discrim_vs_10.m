...
stimset.stims(stimcount).tag = ['fathers_song'];
...
stimset.stims(stimcount).fname = 'yellow9red90_tutor_song';
stimset.total_length_est = stimset.total_length_est + stimset.stims(stimcount).length/fs + 4;


stimset.stims=stimset.stims(1:10);
stimset.numstims = length(stimset.stims);
save_krank_stimuli(stimset, pathdata.stim_path, 'n230_y9r90_discrim_vs_10')
