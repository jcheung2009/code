...
%                 end
    ...
    filedata.num_amplifier_channels=num_amplifier_channels;
    filedata.num_aux_input_channels=num_aux_input_channels;
    filedata.num_supply_voltage_channels=num_supply_voltage_channels;
    ...
    rhd_data(nind).song = board_adc_data;
    rhd_data(nind).filedata = filedata;
%     
