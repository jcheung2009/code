function [] = mAutoLabel(batch,the_template, syll,thresh,FFTthresh,minCount,maxCount,refrac,int,buffertime,chanSpec)
%
...
mk_tempf(batch,the_template,buffertime,chanSpec);

if size(the_template,2)==1
    %min threshold
...
label_trigs(batch,syll,chanSpec,thresh,1,1,int,30,2);